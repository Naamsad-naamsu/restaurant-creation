...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form  method="POST" action="{{ route('restaurant.update',[$category->id]) }}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    {{ method_field('PATCH') }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  name="cost" value="{{ old('cost',$category->product_limit) }}" placeholder="Enter Cost">
                                    </div>
                            </div>
                        </div>
